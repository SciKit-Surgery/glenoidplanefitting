...
def test_creatFriedmanLine():
    """
    Tests that the createFriedmanLine returns the midpoint
    """
    anterior_margin = [3.0, 5.0, 9.0]
    posterior_margin = [11.0, 13.0, 17.0]

    friedman_point = frd.createFriedmanLine(anterior_margin, posterior_margin)
...
def test_FriedmanVersion():
    """
    Tests that FriedmanVersion correctly returns the version
    ...
    version = frd.FriedmanVersion(anterior_margin, 
