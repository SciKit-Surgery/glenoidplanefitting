...
# -*- coding: utf-8 -*-
#
# glenoidplanefitting documentation build configuration file, created by
...
# This allows modules to be indexed under the submodule name rather than all appearing under glenoidplanefitting
modindex_common_prefix = [
    'glenoidplanefitting.'
]

# General information about the project.
project = u'glenoidplanefitting'
copyright = u"2021, University College London"
author = u'Asta Olafsdottir'
...
# The short X.Y version.
# version = glenoidplanefitting.__version__
# The full version, including alpha/beta/rc tags.
# release = glenoidplanefitting.__version__
...
htmlhelp_basename = 'glenoidplanefittingdoc'
...
latex_documents = [
    ('index', 'glenoidplanefitting.tex',
     u'glenoidplanefitting Documentation',
     u'Asta Olafsdottir', 'manual'),
]
...
man_pages = [
    ('index', 'glenoidplanefitting',
     u'glenoidplanefitting Documentation',
     [u'Asta Olafsdottir'], 1)
]
